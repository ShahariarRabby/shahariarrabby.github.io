...
var external = [
  ...
  {"name":"PASCAL VOC", "url":"http://host.robots.ox.ac.uk:8080/pascal/VOC/", "src":"images/external/pascal.jpg", "description":"Annotations for PASCAL VOC 2007 and 2012 in COCO format. This allows use of the PASCAL detection data with the COCO API (including visualization and evaluation tools). JSON available <a href='https://storage.googleapis.com/coco-dataset/external/PASCAL_VOC.zip'>here</a>."},
  {"name":"ImageNet Detection", "url":"http://image-net.org/challenges/LSVRC/", "src":"images/external/imagenet.jpg", "description":"Annotations for ImageNet 2014 train/val in COCO format. This allows use of the ImageNet detection data with the COCO API (including visualization and evaluation tools). JSON available <a href='https://storage.googleapis.com/coco-dataset/external/ILSVRC2014.zip'>here</a>."},
...
function initLeaderboardKeypoints() {
  var types = ["kpt_dev", "kpt_standard", "kpt_challenge2016", "kpt_challenge2017", "kpt_challenge2018"];
